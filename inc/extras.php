...
function qot_modify_post_title( $input ) {
    global $post_type;
...
add_filter('enter_title_here', 'qot_modify_post_title');

/**
* Filter the post archive -> is like the dot notation in php when retrieving information inside of an object ..key value pairs ex. echo $dog->walk(); or Javascript $dog.walk();
*/
